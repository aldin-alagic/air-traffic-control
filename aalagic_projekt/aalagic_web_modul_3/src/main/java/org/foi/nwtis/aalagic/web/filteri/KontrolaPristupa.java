...
public class KontrolaPristupa implements Filter {
        ...
        if (request instanceof HttpServletRequest) {
            ...
            if (session != null && session.getAttribute("korisnik") != null) {
                ...
                if (korisnik.getKorIme() != null && !korisnik.getKorIme().trim().isEmpty()) {
                    ...
                    d.setKorisnickoIme(korisnik.getKorIme());
                    d.setUrl(((HttpServletRequest) request).getRequestURL().toString());
                    d.setIpAdresa("localhost");
                    d.setVrijemePrimanja(new Date());
                    dnevnik = d;
                }
            }
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
        ...
        if (dnevnik != null) {
            ...
            long trajanje = (trenutno - dnevnik.getVrijemePrimanja().getTime());
