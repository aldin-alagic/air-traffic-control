...
public class Airplanes implements Serializable {
    ...
    public Airplanes(String icao24, int firstseen, int lastseen, String estarrivalairport, int estdepartureairporthorizdistance, int estdepartureairportvertdistance, int estarrivalairporthorizdistance, int estarrivalairportvertdistance, int departureairportcandidatescount, int arrivalairportcandidatescount, Date stored) {
        this.icao24 = icao24;
        this.firstseen = firstseen;
        this.lastseen = lastseen;
        this.estarrivalairport = estarrivalairport;
    ...
    public String toString() {
        return "org.foi.nwtis.aalagic.ejb.eb.Airplanes[ id=" + id + " ]";
    }
