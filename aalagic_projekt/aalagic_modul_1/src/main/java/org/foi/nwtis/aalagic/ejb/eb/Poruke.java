...
public class Poruke implements Serializable {
    ...
    public Poruke(Integer id, String korisnik, String komanda, Date primanje, Date slanje) {
        this.id = id;
    ...
    public Date getPrimanje() {
        return primanje;
    }

    public void setPrimanje(Date primanje) {
        this.primanje = primanje;
    }

    public Date getSlanje() {
        return slanje;
    }

    public void setSlanje(Date slanje) {
        this.slanje = slanje;
    }
    ...
    public String toString() {
        return "org.foi.nwtis.aalagic.ejb.eb.Poruke[ id=" + id + " ]";
    }
